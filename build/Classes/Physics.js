export const vectorMagnitude = (v) => {
...
export class Physics {
    ...
    collisionBallLine(ball, line, lineLength) {
        const x1 = line[0].x;
        const x2 = line[1].x;
        const y1 = line[0].y;
        const y2 = line[1].y;
    ...
    calculateBounce(ball, vector, state) {
    ...
    testCollisionContinuous(ball, sides, timeDelta) {
    ...
    testGlobalCollision(ball, polygons, timeDelta, state) {
        let collision = false;
